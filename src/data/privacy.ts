...
export const privacyData: PrivacyPageData = {
  meta: {
    ...
    description: 'Learn how Chronicles Europe collects, uses, and protects your personal information. Our privacy policy outlines your rights and our responsibilities.',
  ...
  content: `
    ...
    Personally identifiable information, such as your name, shipping address, email address, telephone number, and any other information that identifies you as an individual, that you voluntarily give to us when choosing to participate in various activities related to the Site.</p>
    ...
    Financial information, such as data related to your payment method (e.g., valid credit card number, card brand, expiration date) that we may collect when you purchase, order, return, exchange products or services.</p>
    ...
    If we believe the release of information about you is necessary to respond to legal process, to investigate or remedy potential violations of our policies, or to protect the rights, property, and safety of others.</p>
    ...
    <ul>
      <li>Logging into your account settings and updating your user profile</li>
    ...
    Email: privacy@chronicleseurope.com</p>
