...
import type { HeroSection } from "@/data/double-decker-stands"
import { useQuoteModal } from "@/contexts/QuoteModalContext"
import { DOUBLE_DECKER_STANDS_HERO_BG_IMAGE } from "@/data/double-decker-stands"
...
export default function HeroSection({ heroData }: HeroSectionProps) {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(${DOUBLE_DECKER_STANDS_HERO_BG_IMAGE})`,
