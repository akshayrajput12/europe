...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(${modularStandsData.hero.backgroundImage})`,
    ...
    >
      <div className="container mx-auto px-4 text-center">
        <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4">{modularStandsData.hero.title}</h1>
